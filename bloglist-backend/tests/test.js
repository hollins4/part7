...
describe('favorite blog', () => {
  ...
  test('determine which blog has the most likes', () => {
...
describe('author with most blog posts and most likes', () => {

  test('determine which author has the most blog posts', () => {
    const result = listHelper.mostBlogs(listHelper.blogs)
    expect(result).toEqual({author: "Robert C. Martin",blogs: 3})
  })

  test('determine which author has the most blog likes ', () => {
